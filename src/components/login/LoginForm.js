...
const generateLoginFormValues =() => {
    return {
        email: {
            ...
            error:"",
            validateInput: (email) =>
            email.includes("gmail.com") ? null : "Не действительный адрес"
        },
            ...
            password: {
                ...
                password.length > 5 ? null : "Введите не менее 5 символов"
            }
...
const LoginForm = () => {
  ...
  return (
    ...
    />
    <button disabled={isButtonDisabled} onClick={onFormSubmit}>Авторизоваться</button>
    </FormControl>
  )
}
